                ...
                (p = function (e, n, i, o) {
                  ...
                  if (
                    ...
                    for (
                      ...
                      if ("require" === (d = (h = f(n[y], w)).f))
                        b[y] = g.require(e);
                      else if ("exports" === d) (b[y] = g.exports(e)), ($ = !0);
                      else if ("module" === d) c = b[y] = g.module(e);
                      else if (r(m, d) || r(v, d) || r(_, d)) b[y] = l(d);
                      else {
                        if (!h.p) throw new Error(e + " missing " + d);
                        h.p.load(h.n, s(o, !0), a(d), {}), (b[y] = m[d]);
                      }
                    (p = i ? i.apply(m[e], b) : void 0),
                      e &&
          ...
          function t(t) {
            ...
            if (
              ...
              if (
                ...
                (!o || h < o) && ((o = h), i(s, h) && (o /= 40)),
                i(s, h) && ((c /= 40), (d /= 40), (p /= 40)),
