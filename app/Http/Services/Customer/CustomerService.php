...
class CustomerService
{
    ...
    public function create($request)
    {
        try {
            ...
            Session::flash('error', "Đăng ký tài khoản tài khoản thất bại. Vui lòng thử lại !");
            return false;
        }
    }
    ...
    function updateAddressInformation($request)
    {
        try {
            $name = $request->input('fullname');
            $mobile = $request->input('mobile');
            ...
            Session::flash('success', 'Cập nhật sổ địa chỉ thành công !');
            return true;
        } catch (\Exception $err) {
            Session::flash('error', 'Cập nhật sổ địa chỉ thất bại !');
            return false;
        }
    }
}