...
class OrderController extends Controller
{
    ...
    public function __construct(OrderService $orderService, CustomerService $customerService, OrderStatusService $orderStatusService, ShippingStatusService $shippingStatusService, AddressService $addressService, CompanyService $companyService)
    {
