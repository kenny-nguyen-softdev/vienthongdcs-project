...
Route::get('/ajaxShowQuickViewProduct', [AjaxController::class, 'ajaxShowQuickViewProduct'])->name('ajaxShowQuickViewProduct');
...
Route::post('/subscribeByEmail', [AjaxController::class, 'subscribeByEmail'])->name('subscribeByEmail');