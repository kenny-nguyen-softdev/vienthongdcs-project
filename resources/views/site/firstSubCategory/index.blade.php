    ...
    <body class="product-category-57 home1">
        ...
        <div class="container layer-category">
            ...
            <ul class="breadcrumb">
                ...
                <li><a
                        href="{{ route('site.parentCategory.index', [$parentCategory->slug]) }}">{{ $firstSubCategory->parentCategory->name }}</a>
                </li>
                <li>
                    <a
                        href="{{ route('site.firstSubCategory.index', [$parentCategory->slug, $firstSubCategory->slug]) }}">{{ $firstSubCategory->name }}</a>
                </li>
            </ul>
            <div class="row">
                <div class="col-order">
                    <aside id="column-left" class="col-sm-12 col-md-3">
                        <div class="layernavigation-module">
                            <div class="panel panel-default">
                                ...
                                <div class="layered">
                                    <div class="list-group">
                                                ...
                                                <div id="filter-group3">
                                                    @foreach ($firstSubCategory->secondSubCategories as $secondSubCategory)
                                                        <a class="a-filter add-filter"
                                                            href="{{ route('site.secondSubCategory.index', [$parentCategory->slug, $firstSubCategory->slug, $secondSubCategory->slug]) }}"
                                                            name="18"><i
                                                                class="fa fa-square-o"></i>{{ $secondSubCategory->name }}
                                                            ({{ count($secondSubCategory->products) }})
                                                        </a>
                                                    @endforeach
                                                </div>
                                            </div>
                                        ...
                                        <form id="filter-price"
                                            action="{{ route('site.firstSubCategory.index', [$parentCategory->slug, $firstSubCategory->slug]) }}"
                                ...
                                <input type="hidden" class="filter-url"
                                    value="index55b6.json?route=extension/module/oclayerednavigation/category&amp;path=57" />
                                <input type="hidden" class="price-url"
                                    value="index55b6.json?route=extension/module/oclayerednavigation/category&amp;path=57" />
                            </div>
                    ...
                    <div id="content" class="col-md-9 col-sm-12">
                                        ...
                                        <div class="register-form-content">
                                            ...
                                            <p>
                                                ...
                                                <a onclick="ocajaxlogin.appendLoginForm()"
                                                    href="javascript:void(0);">login form</a>.
                                            </p>
                                            <form
                                                ...
                                                <fieldset id="address">
                                                    ...
                                                    <div class="form-group required">
                                                        <label class="col-sm-2 control-label"
                                                            for="input-address-1">Address 1</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-2 control-label"
                                                            for="input-address-2">Address 2</label>
                                                        <div class="col-sm-10">
                        ...
                        <div class="category-info">
                            <h2 class="category-name">{{ $firstSubCategory->name }}</h2>
                        </div>
