    ...
    <body class="product-category-61 home1">
        ...
        <div class="container layer-category">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a
                        href="{{ route('site.secondSubCategory.index', [$parentCategory->slug, $firstSubCategory->slug, $secondSubCategory->slug]) }}">{{ $secondSubCategory->name }}</a>
                </li>
            </ul>
                ...
                <div class="col-order">
                        ...
                        <div class="layernavigation-module">
                            <div class="panel panel-default">
                                ...
                                <input type="hidden" class="filter-url"
                                    value="index8aae.json?route=extension/module/oclayerednavigation/category&amp;path=61" />
                    ...
                    <div id="content" class="col-md-9 col-sm-12">
                        ...
                        <div class="category-info">
                            <h2 class="category-name">{{ $secondSubCategory->name }}</h2>
                        </div>
