    ...
    <body class="blog-article home1">
        ...
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li><a href="{{ route('site.introduction.show', [$introduction->slug]) }}">{{ $introduction->title }}</a>
                </li>
            </ul>
            <div class="row">
                <div id="content" class="col-sm-12">
                                        ...
                                        <form action="#" method="post" id="ajax-login-form"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="email" value=""
                                                    placeholder="E-Mail Address" id="input-email" class="form-control" />
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label" for="input-password">Password</label>
                                                <input type="password" name="password" value="" placeholder="Password"
                                                    id="input-password" class="form-control" />
                                                <a class="forgotten" href="indexacda.html?route=account/forgotten">Forgotten
                                                    Password</a>
                                            </div>
                                            <div class="action">
                                                ...
                                                <button class="button" type="button"
                                                    onclick="ocajaxlogin.appendRegisterForm()"><span>Create an
                                                        account</span></button>
                                                <img class="ajax-load-img" alt="" src="image/catalog/AjaxLoader.gif"
                                                    width="30" height="30" />
                                            </div>
                                        </form>
                                    </div>
                                ...
                                <div class="ajax-container">
                                    <div class="register-form-content">
                                        ...
                                        <p>If you already have an account with us, please login at the <a
                                                onclick="ocajaxlogin.appendLoginForm()" href="javascript:void(0);">login
                                                form</a>.</p>
                                        <form
                                                ...
                                                <div class="form-group required">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name="country_id" id="input-country"
                                                            ...
                                                            <option value="222" selected="selected">United Kingdom
                                                            </option>
                            ...
                            <div class="ajax-content">
                                <div class="ajax-container">
                                    <div class="success-content">
                                        ...
                                        <p>You can now take advantage of member privileges to enhance your online shopping
                                            experience with us.</p>
                                        <p>If you have ANY questions about the operation of this online shop, please e-mail
                                            the store owner.</p>
                                        <p>A confirmation has been sent to the provided e-mail address. If you have not
                                            received it within the hour, please <a
                                                href="index2724.html?route=information/contact">contact us</a>.</p>
                                        <div class="buttons">
                                            <div class="pull-right"><button class="button"
                                                    onclick="window.location.href='indexe223.html?route=account/account'"><span>Continue</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="ajax-content">
                                <div class="ajax-container">
                                    <div class="success-content">
                                        ...
                                        <p>Your shopping cart has been saved, the items inside it will be restored whenever
                                            you log back into your account.</p>
                                        <div class="buttons">
                                            <div class="pull-right"><button class="button"
                                                    onclick="window.location.href='index9328.html?route=common/home'"><span>Continue</span></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="article-container col-md-12">
                        ...
                        <div class="article-title text-center">{{ $introduction->title }}</div>
                        <div class="article-date">{{ $introduction->created_date }}</div>
