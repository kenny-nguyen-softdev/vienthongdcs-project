                ...
                <div class="col-order">
                    <div id="content" class="col-sm-12">
                        ...
                        <div class="link-compare">
                            <h1 id="compare-total">Sản Phẩm Đã Xem</h1>
                            <p>Danh sách {{ count($passedProductIds) }} sản phẩm</strong>
                            </p>
                        </div>
                        <div class="toolbar toolbar-products">
                            ...
                            <div class="toolbar-amount">
                                <span>Đang hiện {{ count($passedProductIds) }} sản phẩm</span>
                            </div>
                            {{-- @include('site.layout.arrangementFilter') --}}
                        </div>
                        <div class="custom-products quickview-add">

                            @foreach ($passedProductIds as $passedProductId)
                                @php
                                    $product = App\Helpers\ProductHelper::getProductById($passedProductId);
                                @endphp
                                <div
                        ...
                        <div class="toolbar toolbar-products toolbar-bottom">
                            <div class="toolbar-amount">
                                <span>Danh sách {{ count($passedProductIds) }} sản phẩm</span>
                            </div>
                            {{-- <div class="pages">
                                <ul class="pagination">
                                    @if ($page > 1)
