                ...
                <div class="col-md-6">
                    <div class="authincation-content">
                        <div class="row no-gutters">
                            <div class="col-xl-6"
                                style="background-color: #1a2e83; display:flex; justify-content:center;align-item: center;align-items:center;">
                                <img src="{{ asset("storage/uploads/$company->logo") }}" width="80%"
                                    alt="{{ $company->name }}">
                            </div>
                            <div class="col-xl-6">
                                <div class="auth-form">
