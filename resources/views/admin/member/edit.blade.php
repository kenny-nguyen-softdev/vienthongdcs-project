            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">Thành Viên - <span class="fw-normal">Chỉnh Sửa Thành Viên
                                    Có Mã
                                    #{{ $user->id }}</span>
                            </h4>
                        ...
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                ...
                                <a href="{{ route('admin.member.index') }}" class="breadcrumb-item">Danh Sách
                                    Thành Viên</a>/
                                <a href="{{ route('admin.member.edit', [$user->id]) }}" class="breadcrumb-item">Chỉnh
                                    Sửa Thành Viên Có
                                    Mã
                                    #{{ $user->id }}</a>
                            </div>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Chỉnh Sửa Thành Viên Có Mã #{{ $user->id }}</h5>
                        </div>

                        <form class="form-validate-jquery" action="{{ route('admin.member.update', [$user->id]) }}"
        ...
        const FileUpload = (function() {
            ...
            const _componentFileUpload = function() {
                ...
                $(".file-input-preview.private_image").fileinput({
                    ...
                    removeClass: "btn btn-light",
                    initialPreview: [
                        "/storage/uploads/{{ $user->private_image }}",
                    ],
                    initialPreviewConfig: [{
                        caption: "{{ $user->private_image }}",
                    }, ],
                ...
                $(".file-input-preview.cover_image").fileinput({
                    ...
                    removeClass: "btn btn-light",
                    initialPreview: [
                        "/storage/uploads/{{ $user->cover_image }}",
                    ],
                    initialPreviewConfig: [{
                        caption: "{{ $user->cover_image }}",
                    }, ],
                    initialPreviewAsData: true,
                    overwriteInitial: true,
                    maxFileSize: 100000000,
