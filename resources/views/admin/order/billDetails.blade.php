                                    ...
                                    <div class="basic-list-group" style="">
                                        <div class="list-group" style="">
                                            <a href="javascript:void()"
                                                ...
                                                <div>
                                                    <label class="card-title mb-2" style=""><b>Mã đơn
                                                            hàng:</b><br>
                                                        <p class="mb-1">{{ $order->id }}</p>
                                                    </label>
                                                    <label class="card-title mb-2" style=""><b>Ngày đặt
                                                            hàng:</b><br>
                                                        <p class="mb-1">
                                            ...
                                            <a href="javascript:void()"
                                                ...
                                                <label class="card-title mb-2" style=""><b>Tên người
                                                        nhận:</b><br>
                                                    <span class="mb-1">{{ $order->shipping_fullname }}</span>
                                                </label>
                                                <label class="card-title mb-2" style=""><b>Địa chỉ giao
                                                        hàng:</b><br>
                                                    <span
