        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tạo mới trang thông tin</h4>
                </div>
                <div class="card-body">
                    <form class="form-valide-with-icon" action="{{ route('admin.page.store') }}" method="POST"
                        ...
                        <div class="form-group">
                            <label class="text-label">Loại trang</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="fa fa-list" aria-hidden="true"></i></span>
                                </div>
                                <select class="form-control" name="type">
                                    <option value="">Vui lòng chọn loại trang</option>
                                    <option value="policy">Trang Chính Sách Công Ty</option>
                                    <option value="customer_tutorials">Trang Hướng Dẫn Khách Hàng</option>
                                </select>
                            </div>
