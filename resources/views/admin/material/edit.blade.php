            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">Nguyên Liệu Của Sản Phẩm - <span class="fw-normal">Chỉnh Sửa Minh
                                    Bạch
                                    Nguyên Liệu Có Mã
                                    #{{ $material->id }}</span>
                            </h4>
                    ...
                    <div class="page-header-content d-lg-flex border-top">
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                <a href="{{ route('admin.material.index') }}" class="breadcrumb-item"><i
                                        class="ph-house"></i></a>
                                <a href="{{ route('admin.material.index') }}" class="breadcrumb-item">Danh Sách
                                    Nguyên Liệu Của Sản Phẩm</a>/
                                <a href="{{ route('admin.material.edit', [$material->id]) }}" class="breadcrumb-item">Chỉnh
                                    Sửa Nguyên Liệu Của Sản Phẩm Có
                                    Mã
                                    #{{ $material->id }}</a>
                            </div>
                        </div>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Chỉnh Sửa Nguyên Liệu Của Sản Phẩm Có Mã #{{ $material->id }}</h5>
                        </div>

                        <form class="form-validate-jquery" action="{{ route('admin.material.update', [$material->id]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-form-label col-lg-3">Tên nguyên liệu của sản phẩm <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="ph-text-aa"></i></span>
                                                <input type="text" name="name" class="form-control" required=""
                                                    placeholder="Tên nguyên liệu của sản phẩm..."
                                                    value="{{ $material->name }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-form-label col-lg-3">Sản Phẩm <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <select class="form-control" name="product" id="product">
                                                    ...
                                                    @foreach ($products as $product)
                                                        <option value="{{ $product->id }}"
                                                            {{ $material->product->id == $product->id ? 'selected' : '' }}>
                                                            {{ $product->name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="color" class="form-control" required=""
                                                    placeholder="Màu Sắc..." value="{{ $material->color }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="description" class="form-control" id="content0" rows="10" cols="80">{{ $material->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
        ...
        const FileUpload = (function() {
            ...
            const _componentFileUpload = function() {
                ...
                $(".file-input-preview.featured_image").fileinput({
                    ...
                    removeClass: "btn btn-light",
                    initialPreview: [
                        "/storage/uploads/{{ $material->featured_image }}",
                    ],
                    initialPreviewConfig: [{
                        caption: "{{ $material->featured_image }}",
                    }, ],
