            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">Cam Kết - <span class="fw-normal">Chỉnh Sửa Cam Kết Có Mã
                                    #{{ $commitment->id }}</span>
                            </h4>
                        ...
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                ...
                                <a href="{{ route('admin.commitment.index') }}" class="breadcrumb-item">Danh Sách
                                    Cam Kết</a>/
                                <a href="{{ route('admin.commitment.edit', [$commitment->id]) }}"
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Chỉnh Sửa Cam Kết Có Mã #{{ $commitment->id }}</h5>
                        </div>

                        <form class="form-validate-jquery"
                            action="{{ route('admin.commitment.update', [$commitment->id]) }}" novalidate="novalidate"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" class="form-control" required=""
                                                    placeholder="Tên cam kết..." value="{{ $commitment->name }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="icon_image" class="file_name"
                                                    value="{{ $commitment->icon_image }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="description" class="form-control" id="content0" rows="10" cols="80">{{ $commitment->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="content" class="form-control" id="content1" rows="10" cols="80">{{ $commitment->content }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="sort_by" class="form-control" required=""
                                                    placeholder="Sắp xếp..." value="{{ $commitment->sort_by }}">
                                            </div>
                                        </div>
                                    </div>
        ...
        const FileUpload = (function() {
            ...
            const _componentFileUpload = function() {
                ...
                $(".file-input-preview.icon_image").fileinput({
                    ...
                    removeClass: "btn btn-light",
                    initialPreview: [
                        "/storage/uploads/{{ $commitment->icon_image }}",
                    ],
                    initialPreviewConfig: [{
                        caption: "{{ $commitment->icon_image }}",
                    }, ],
