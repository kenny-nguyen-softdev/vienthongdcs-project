            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">Menu Phụ - <span class="fw-normal">Chỉnh Sửa Bài Viết
                                    Của Chúng Tôi Có Mã
                                    #{{ $subMenu->id }}</span>
                            </h4>
                        ...
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                ...
                                <a href="{{ route('admin.subMenu.index') }}" class="breadcrumb-item">Danh Sách
                                    Menu Phụ</a>/
                                <a href="{{ route('admin.subMenu.edit', [$subMenu->id]) }}" class="breadcrumb-item">Chỉnh
                                    Sửa Menu Phụ Có
                                    Mã
                                    #{{ $subMenu->id }}</a>
                            </div>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Chỉnh Sửa Menu Phụ Có Mã #{{ $subMenu->id }}</h5>
                        </div>

                        <form class="form-validate-jquery" action="{{ route('admin.subMenu.update', [$subMenu->id]) }}"
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="name" class="form-control" required=""
                                                    placeholder="Tên menu phụ..." value="{{ $subMenu->name }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="url" class="form-control" required=""
                                                    placeholder="Đường dẫn..." value="{{ $subMenu->url }}">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="sort_by" class="form-control" required=""
                                                    placeholder="Thứ tự sắp xếp..." value="{{ $subMenu->sort_by }}">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group">
                                                <label class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="active"
                                                        value="1" {{ $subMenu->active == 1 ? 'checked' : '' }}>
        ...
        const FileUpload = (function() {
            ...
            const _componentFileUpload = function() {
                ...
                $(".file-input-preview.icon_code").fileinput({
                    ...
                    removeClass: "btn btn-light",
                    initialPreview: [
                        "/storage/uploads/{{ $subMenu->icon_code }}",
                    ],
                    initialPreviewConfig: [{
                        caption: "{{ $subMenu->icon_code }}",
                    }, ],
