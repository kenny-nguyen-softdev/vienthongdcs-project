        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Chỉnh sửa danh mục phụ 1 có mã <span
                            style="color: red;">#{{ $firstSubCategory->id }}</span>
                    </h4>
                </div>
                <div class="card-body">
                    <form class="form-valide-with-icon"
                        action="{{ route('admin.firstSubCategory.update', [$firstSubCategory->id]) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="val-username1" name="name"
                                    placeholder="danh mục phụ 1.." value="{{ $firstSubCategory->name }}">
                            </div>
                                ...
                                <select class="form-control" name="parentCategory">
                                    ...
                                    @foreach ($parentCategories as $parentCategory)
                                        <option value="{{ $parentCategory->id }}"
                                            {{ $firstSubCategory->parentCategory->id == $parentCategory->id ? 'selected' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="val-username1" name="title_seo"
                                    placeholder="Title Seo.." value="{{ $firstSubCategory->title_seo }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="val-username1" name="meta_des"
                                    placeholder="Meta des.." value="{{ $firstSubCategory->meta_des }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="val-username1" name="meta_key"
                                    placeholder="Meta key.." value="{{ $firstSubCategory->meta_key }}">
                            </div>
