        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Chỉnh sửa bài viết trên Header có mã <span
                            style="color: red;">#{{ $headerPost->id }}</span>
                    </h4>
                </div>
                <div class="card-body">
                    <form class="form-valide-with-icon" action="{{ route('admin.headerPost.update', $headerPost->id) }}"
                        method="POST" novalidate="novalidate">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label class="text-label">Tên bài viết trên Header</label>
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="val-username1" name="name"
                                    placeholder="Tên bài viết trên Header.." value="{{ $headerPost->name }}">
                            </div>
                        ...
                        <div class="form-group">
                            <label class="text-label">Icon Code</label>
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text"> <i class="fa fa-code" aria-hidden="true"></i>
                                    </span>
                                </div>
                                <input type="text" class="form-control" id="val-username1" name="icon_code"
                                    placeholder="Icon Code.." value="{{ $headerPost->icon_code }}">
                            </div>
                            @if (!empty($errors->first('icon_code')))
                                <div class="col-md-6" style="color:red; margin-bottom:12px;">
                                    {{ $errors->first('icon_code') }}</div>
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" id="val-username1" name="sort_by"
                                    placeholder="Thứ tự sắp xếp.." value="{{ $headerPost->sort_by }}">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" class="form-control" id="content" rows="10" cols="80">{{ $headerPost->content }}</textarea>
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input type="checkbox" name="is_active" class="form-check-input" value="1"
                                        {{ $headerPost->is_active == 1 ? 'checked' : '' }}>Kích
                                    hoạt
                                </label>
                            </div>
                        </div>
