            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">Thành Phần Nguyên Liệu - <span class="fw-normal">Tạo Mới Thành Phần
                                    Nguyên Liệu</span>
                            </h4>
                        ...
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                ...
                                <a href="{{ route('admin.component.index') }}" class="breadcrumb-item">Danh Sách Thành Phần
                                    Nguyên Liệu</a>/
                                <a href="{{ route('admin.component.create') }}" class="breadcrumb-item">Tạo
                                    Mới Thành Phần Nguyên Liệu</a>
                            </div>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Tạo Mới Thành Phần Nguyên Liệu</h5>
                        </div>

                        <form class="form-validate-jquery" action="{{ route('admin.component.store') }}"
