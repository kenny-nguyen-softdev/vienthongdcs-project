            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">Bài Viết Của Chúng Tôi - <span class="fw-normal">Tạo Mới Bài Viết
                                    Của Chúng Tôi</span>
                            </h4>
                    ...
                    <div class="page-header-content d-lg-flex border-top">
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                <a href="{{ route('admin.post.index') }}" class="breadcrumb-item"><i
                                        class="ph-house"></i></a>
                                <a href="{{ route('admin.post.index') }}" class="breadcrumb-item">Danh Sách
                                    Bài Viết Của Chúng Tôi</a>/
                                <a href="{{ route('admin.post.store') }}" class="breadcrumb-item">Tạo Mới Bài Viết Của
                                    Chúng Tôi</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Tạo Mới Bài Viết Của Chúng Tôi</h5>
                        </div>

                        <form class="form-validate-jquery" action="{{ route('admin.post.store') }}" novalidate="novalidate"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    {{-- <div class="row mb-3">
                                        <label class="col-form-label col-lg-3">Danh mục bài viết <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="description_1" class="form-control" id="content1" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="description_2" class="form-control" id="content2" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="description_3" class="form-control" id="content3" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="description_4" class="form-control" id="content4" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="description_5" class="form-control" id="content5" rows="10" cols="80"></textarea>
                                            </div>
                                        </div>
                                    </div>
