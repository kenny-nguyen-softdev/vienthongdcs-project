            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">Minh Bạch Nguyên Liệu - <span class="fw-normal">Tạo Mới Minh Bạch
                                    Nguyên Liệu</span>
                            </h4>
                    ...
                    <div class="page-header-content d-lg-flex border-top">
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                ...
                                <a href="{{ route('admin.mainIngredient.create') }}" class="breadcrumb-item">Tạo Mới Minh
                                    Bạch Nguyên Liệu</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Tạo Mới Minh Bạch Nguyên Liệu</h5>
                        </div>

                        <form class="form-validate-jquery" action="{{ route('admin.mainIngredient.store') }}"
