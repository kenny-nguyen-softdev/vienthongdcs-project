            ...
            <div class="content-inner">
                ...
                <div class="page-header page-header-light shadow">
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">Minh Bạch Nguyên Liệu - <span class="fw-normal">Chỉnh Sửa Minh Bạch
                                    Nguyên Liệu Có Mã
                                    #{{ $mainIngredient->id }}</span>
                            </h4>
                    ...
                    <div class="page-header-content d-lg-flex border-top">
                        <div class="d-flex">
                            <div class="breadcrumb py-2">
                                <a href="{{ route('admin.mainIngredient.index') }}" class="breadcrumb-item"><i
                                        class="ph-house"></i></a>
                                <a href="{{ route('admin.mainIngredient.index') }}" class="breadcrumb-item">Danh Sách
                                    Minh Bạch Nguyên Liệu</a>/
                                <a href="{{ route('admin.mainIngredient.edit', [$mainIngredient->id]) }}"
                                    class="breadcrumb-item">Chỉnh
                                    Sửa Minh Bạch Nguyên Liệu Có
                                    Mã
                                    #{{ $mainIngredient->id }}</a>
                            </div>
                        </div>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="mb-0">Chỉnh Sửa Minh Bạch Nguyên Liệu Có Mã #{{ $mainIngredient->id }}</h5>
                        </div>

                        <form class="form-validate-jquery"
                            action="{{ route('admin.mainIngredient.update', [$mainIngredient->id]) }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-form-label col-lg-3">Tên minh bạch nguyên liệu <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="ph-text-aa"></i></span>
                                                <input type="text" name="name" class="form-control" required=""
                                                    placeholder="Tên minh bạch nguyên liệu..."
                                                    value="{{ $mainIngredient->name }}">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label class="col-form-label col-lg-3">Màu Sắc <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <span class="input-group-text"><i class="ph-link"></i></span>
                                                <input type="text" name="color" class="form-control" required=""
                                                    placeholder="Màu Sắc..." value="{{ $mainIngredient->color }}">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label class="col-form-label col-lg-3">Ảnh nổi bật (226px × 228px)<span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="hidden" name="featured_image" class="file_name"
                                                    value="{{ $mainIngredient->featured_image }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <textarea name="description" class="form-control" id="content0" rows="10" cols="80">{{ $mainIngredient->description }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="sort_by" class="form-control" required=""
                                                    placeholder="Sắp xếp..." value="{{ $mainIngredient->sort_by }}">
                                            </div>
                                        </div>
                                    </div>

                                    <div class="row mb-3">
                                        <label class="col-form-label col-lg-3">Hiển thị </label>
                                        <div class="col-lg-9">
                                            <div class="input-group">
                                                <label class="form-check form-switch">
                                                    <input type="checkbox" class="form-check-input" name="active"
                                                        value="1"
                                                        {{ $mainIngredient->active == 1 ? 'checked' : '' }}>
        ...
        const FileUpload = (function() {
            ...
            const _componentFileUpload = function() {
                ...
                $(".file-input-preview.featured_image").fileinput({
                    ...
                    removeClass: "btn btn-light",
                    initialPreview: [
                        "/storage/uploads/{{ $mainIngredient->featured_image }}",
                    ],
                    initialPreviewConfig: [{
                        caption: "{{ $mainIngredient->featured_image }}",
                    }, ],
